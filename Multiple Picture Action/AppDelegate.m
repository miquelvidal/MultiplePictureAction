...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [MkTransporter setObject:self.managedObjectContext forNSString:@"managedObjectContext"];
    ALAssetsLibrary* library = [[ALAssetsLibrary alloc] init];
    [MkTransporter setObject:library forNSString:@"library"];
    [MkAlbumLoader loadAlbums:self.managedObjectContext withAssetLibrary:library];
    return YES;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MultiplePictureAction" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MultiplePictureAction.sqlite"];
